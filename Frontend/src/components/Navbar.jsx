...
const Navbar = () => {
    ...
    <div className='flex items-center justify-between py-5 font-medium'>
       ...
       <Link to={'/'}> <img src={assets.logo} className='w-36 cursor-pointer' alt=''/>
</Link>
        ...
        <div className='flex items-center gap-6'>
            ...
            <p className='absolute -right-1.25 -bottom-1.25 w-4 text-center loading-4 bg-black text-white aspect-square rounded-full text-[8px]'>{getCartCount()}</p>
            </Link>
            <img onClick={()=>{
                setVisible(true)
