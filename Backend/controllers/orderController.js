...
// Placing order using strive nethod
...
const placeOrderStripe = async (req, res) => {
    ...
    payment_method_types: ['card'], // MUST
    mode: 'payment',
    line_items,
...
if (!session || !session.url) {
    console.log("Stripe session failed:", session);
    return res.json({ success: false, message: "No session URL generated" });
}
